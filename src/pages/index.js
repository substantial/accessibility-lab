  ...
  <Layout>
    <Wrapper>
      ...
      <p>
        ...
        as an example of how homonyms and homophones can be used to create
        complicated linguistic constructs through lexical ambiguity.
      </p>
      <p>The sentence employs three distinct meanings of the word buffalo:</p>
      <ul>
        <li>
          as a proper noun to refer to a specific place named Buffalo, the city
          of Buffalo, New York being the most notable;
        </li>
        <li>
      ...
      <p>
        An expanded form of the sentence which preserves the original word order
        is:{" "}
        <strong>
